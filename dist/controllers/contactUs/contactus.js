...
const addContact = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { name, email, phone, subject, description, } = yield validation_1.contactSchema.validate(req.body, { abortEarly: false });
        const data = yield models_1.ContactUsModel.create({
