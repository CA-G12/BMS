...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { title, startDate, endDate, image, description, } = yield advsSchems_1.default.validate(req.body, { abortEarly: false });
        const data = yield models_1.AdvertisementModel.create({
